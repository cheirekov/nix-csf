...
run_shell "generated ruleset key lines" "grep -nE 'chain input|chain forward|country_port_allow|country_port_deny|country_ipv|feed_ipv|dynamic_ban|coexist' /var/lib/nix-csf/generated-ruleset.nft 2>/dev/null || true"
