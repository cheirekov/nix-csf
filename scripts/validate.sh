...
echo "[nix-csf] running x86_64 lightweight checks (version + eval + profile eval + control-plane eval + lfd detector eval + monitoring eval + csf import check + shellcheck + control-plane lint + monitoring pack)"
nix build \
